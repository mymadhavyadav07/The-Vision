...
from Osintgram.src.Osintgram import Osintgram
import argparse
from Osintgram.src import printcolors as pc
from Osintgram.src import artwork
import sys
import signal
...
def main(username):
    ...
    api = Osintgram(username, False, False, None, None, False)
